    ...
    if (command === 'watchlist' || command === 'wl') {
        ...
        if (args.length === 0) {
            ...
            if (command2 === 'a' || command2 === 'add') {
                ...
                if (user !== "484297115841986573" && watchlists[server][user].length === 7) return message.channel.send('You already have 7 stocks in your watchlist, please try removing one first!')
